def main(ctx):
    image_name = "phasecorex/user-debian"
    base_image_name = "library/debian"
    all_image_tags_arches = [{'tags': ['10-slim', 'buster-slim'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['8-slim', 'jessie-slim'], 'arches': ['arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['8', 'jessie'], 'arches': ['arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['9-slim', 'stretch-slim'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['9', 'stretch'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['latest', '10', 'buster'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}]
    other_options = {
        "pre_build_commands": {
            "image": "docker:git",
            "commands": [
        ...
        "downstream_builds": ['PhasecoreX/docker-liquidsoap'],
    }
